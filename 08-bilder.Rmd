...
Bisher konnte ich nur unterschiedliche Bilder für ein Hero-Image, indem ich `<figure>` in Kombination mit `<img>`-(Fallback-)Tag & `<source>`-(Media-Queries)-Tag verwendet habe.
