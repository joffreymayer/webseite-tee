...
Wenn du Hero-Images verwendest, dann kann es sein, dass die Bilder für Tablets & Smartphones falsch "ge-cropt" werden. 

Deshalb ist der Einsatz vom `picture`-Tag sehr empfehlenswert. Das `<picture>`-Element ist sogar in der Lage dem Browser zu sagen, dass es eher ein Bild mit erhöhter Auflösung verwenden soll, wenn es z.B. Iphones mit Retina-Bildschirmen begegnet.
...
- Lese die Antwort mit den meisten upvotes in [diesem Stack-Overflow](https://stackoverflow.com/questions/9808233/is-it-possible-to-put-css-media-rules-inline) thread, damit due verstehen kannst, wie ich das geschafft habe.
